    ...
    >
      <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between z-10 py-16">
        ...
        <motion.div
          ...
          className="w-full md:w-1/2 lg:w-2/3 space-y-3 md:space-y-4 md:text-left text-center md:text-left"
        >
        ...
        >
          <img
            src={Profile_Image}
            alt="M Zaryab Khan"
            className="w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 xl:w-56 xl:h-56 rounded-full shadow-lg object-cover"
          />
        </motion.div>
      </div>
    </section>
